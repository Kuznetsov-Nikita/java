...
public class InputOutputHandler {
    ...
    static public Position readPosition() {
        String whiteCheckersCoords = scanner.nextLine();
        String blackChackersCoords = scanner.nextLine();

        return Parser.stringToPosition(whiteCheckersCoords, blackChackersCoords);
    }
