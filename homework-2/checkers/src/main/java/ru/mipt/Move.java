...
public class Move {
    ...
    /** Координаты хода - массив координат от начальной до конечной, как двигается ходящая шашка */
    final private ArrayList<Coordinates> moveCoords;
    /** Следующая неполученная из хода координата шашки */
    ...
    /**
     * Получить следующую координату, на которую двигается шашка за этот ход
     * @return Следующая координата шашки
     */
    ...
    /**
     * Проверить, есть ли неполученная еще следующая координата шашки
